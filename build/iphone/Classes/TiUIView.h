...
/**
 Base class for all DrawerDemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DrawerDemo view hierarchy (such as wrapped iOS UIViews) was touched.
