...
// in simulator we redefine to format for DrawerDemo Developer console
...
{\
	NSString * exceptionName = [@"org.drawerdemo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.drawerdemo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDrawerDemoNativeItemNone = -1, 
	UIDrawerDemoNativeItemSpinner = -2,
	UIDrawerDemoNativeItemProgressBar = -3,
	
	UIDrawerDemoNativeItemSlider = -4,
	UIDrawerDemoNativeItemSwitch = -5,
	UIDrawerDemoNativeItemMultiButton = -6,
	UIDrawerDemoNativeItemSegmented = -7,
	
	UIDrawerDemoNativeItemTextView = -8,
	UIDrawerDemoNativeItemTextField = -9,
	UIDrawerDemoNativeItemSearchBar = -10,
	
	UIDrawerDemoNativeItemPicker = -11,
	UIDrawerDemoNativeItemDatePicker = -12,
	
	UIDrawerDemoNativeItemInfoLight = -13,
	UIDrawerDemoNativeItemInfoDark = -14,
	
	UIDrawerDemoNativeItemDisclosure = -15,
	
	UIDrawerDemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DrawerDemo instances of
